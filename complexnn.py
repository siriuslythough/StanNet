...
class ComplexAvgPool2d(nn.Module):
    ...
    def forward(self, x):
        ...
        return (self.avg_pool(x.real)).type(torch.complex64) + \
                1j * (self.avg_pool(x.imag)).type(torch.complex64)
...
class ComplexAdaptiveAvgPool2d(nn.Module):
    ...
    def forward(self, input):
        return (self.adaptive_pool(input.real)).type(torch.complex64) + \
                1j * (self.adaptive_pool(input.imag)).type(torch.complex64)
...
class ComplexDropout(nn.Module):
    ...
    def forward(self, input):
        return (self.real_drop(input.real)).type(torch.complex64) + \
               1j * (self.imag_drop(input.imag)).type(torch.complex64)
